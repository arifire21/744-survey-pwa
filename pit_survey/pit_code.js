...
//for listeners
const investmentInput = document.getElementsByName('final-inves');
const drivetrainInput = document.getElementsByName('drivetrain');
const customRadiButtons = document.getElementsByClassName('custom-radio');

//optional inputs
const feedbackContainer = document.getElementById('feedback-container');
const feedbackInput = document.getElementById('feedback');
const otherInput = document.getElementById('other-desc');

const firstRoundTeams = ["744", "179", "180", "1", "2", "3", "59", "11111", "1234567890"];

//attaching all listeners here
investmentInput.forEach(function (element){
  element.addEventListener('click', function(){
    if(element.value === 'Yes'){
      console.log('yes')
      feedbackContainer.style.display = 'block';
    } else if(element.value !='Yes' && feedbackContainer.style.display === 'block') {
      feedbackContainer.style.display = 'none';
    }
  })
})

//attach to custom buttons first

drivetrainInput.forEach(function (element){
  element.addEventListener('click', function(){
    if(element.value === 'Other'){
      console.log('yes')
      otherInput.style.display = 'block';
    } else if(element.value !='Other' && otherInput.style.display === 'block') {
